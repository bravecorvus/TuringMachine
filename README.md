...
And converts it into a text file that can be read by the C++ program in order to define the Turing Machine (description of the file in the <a name="###Turing Machine Logic">Turing Machine Logic Section</a>
