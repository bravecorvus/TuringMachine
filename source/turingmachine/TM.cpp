...
private:
	...
	int currentState = 38; // this var keeps track of which state we are in when processing a string
...
{
	currentState = 38; // make sure we are starting at the start state
