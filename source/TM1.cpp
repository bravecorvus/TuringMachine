/* This program simulates the TM assigned in class on April 11, 2017
...
public:
	...
	vector<char> getTape() {return tape;}
};
...
int main(int argc, char* argv[])
{
	...
	ifstream saintJude(file); // create an ifstream object to read in the Turing machine
	turingMachine saintCatherine(saintJude); // create the Turing machine

	ifstream saintRose(inputStrings); // create an ifstream object for input strings
	...
	//{
		...
		saintCatherine.initializeTape(query); // initialize saintCatherine's tape
